...
public class StudentNotificationViewModel extends ViewModel {

    private MutableLiveData<String> message = new MutableLiveData<>();
    private MutableLiveData<ArrayList<String>> list = new MutableLiveData<>();

    public void fetchNotifications(String orgCode, String className, String section, String rollno) {

        Call<FetchSubjectList> call = RetrofitClient.getInstance().getApi().notificationStudent(orgCode, "Student", className, section, rollno);
